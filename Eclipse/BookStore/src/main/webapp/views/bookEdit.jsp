  	...
  	<div id="addBookBox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
  		<div class="panel panel-info">
  			...
  			<div class="panel-body" style="padding-top:30px">
  				<form:form id="bookForm" class="form-horizontal" action="/editBookPage" modelAttribute="thisBook" method="post">
...
<!--                                </div>                                 -->
  				...
  				<div class="form-group">
  					<form:form id="bookDeleteForm" class="form-horizontal" action="/deleteBook" method="post">
